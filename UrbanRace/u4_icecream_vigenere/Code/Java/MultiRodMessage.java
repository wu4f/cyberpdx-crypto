...
public class MultiRodMessage {
    public static void main(String[] args) {
	if (args.length < 3) {
	    System.err.println("Usage: java MultiRodMessage k1 l1 MSG1 [ k2 l2 MSG2 k3 l3 MSG3 ... ]");
	    System.exit(1);
	}
	...
	for (i = 0; i < max; i++) {
		...
		int letter = ran.nextInt(28);
		comb[i] = (letter >= 26) ? '_' : (char) (letter+'A');
	    }
	}
